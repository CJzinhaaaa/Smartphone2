...
function m(e, t) {
    ...
    if (n = P(e), l = P(t), n || l) return !(!n || !l) && function (e, t) {
        ...
        let n = !0;
        for (let l = 0; n && l < e.length; l++) n = m(e[l], t[l]);
        return n
    }(e, t);
    if (n = U(e), l = U(t), n || l) {
        if (!n || !l) return !1;
...
function Ce(e = !1, t = !1) {
    ...
    we[e] = function (...e) {
        const n = at(this);
        for (let t = 0, a = this.length; t < a; t++) he(n, 0, t + "");
        const l = t.apply(n, e);
...
function _e(e = !1) {
    return function (t, n, l, a) {
        ...
        return t === at(a) && (o ? Y(l, s) && me(t, "set", n, l) : me(t, "add", n, l)), r
    }
}
const Ae = {
        get: ve,
        ...
        deleteProperty: function (e, t) {
            ...
            return l && n && me(e, "delete", t, void 0), l
        },
        has: function (e, t) {
            const n = Reflect.has(e, t);
            return D(t) && ge.has(t) || he(e, 0, t), n
        },
        ownKeys: function (e) {
            return he(e, 0, P(e) ? "length" : ae), Reflect.ownKeys(e)
        }
    },
    Se = {
        get: ye,
...
function Oe(e, t = !1) {
    const n = this.__v_raw,
        l = at(n),
        a = at(e);
    return e !== a && !t && he(l, 0, e), !t && he(l, 0, a), e === a ? n.has(e) : n.has(e) || n.has(a)
}

function Me(e, t = !1) {
    return e = e.__v_raw, !t && he(at(e), 0, ae), Reflect.get(e, "size", e)
}

function Ve(e) {
    e = at(e);
    const t = at(this);
    return Le(t).has.call(t, e) || (t.add(e), me(t, "add", e, e)), this
}
...
function De(e, t) {
    ...
    const o = a.call(n, e);
    return n.set(e, t), s ? Y(t, o) && me(n, "set", e, t) : me(n, "add", e, t), this
}
...
function Ue(e) {
    ...
    const s = t.delete(e);
    return a && me(t, "delete", e, void 0), s
}
...
function $e(e, t) {
    return function (n, l) {
        const a = this,
            ...
            o = at(s),
            r = e ? Ee : t ? Pe : Re;
        return !e && he(o, 0, ae), s.forEach(((e, t) => n.call(l, r(e), r(t), a)))
    }
}
...
class it {
    ...
    get value() {
        return he(at(this), 0, "value"), this._value
    }
    set value(e) {
        Y(at(e), this._rawValue) && (this._rawValue = e, this._value = this._shallow ? e : st(e), me(at(this), "set", "value", e))
    }
}
...
class ht {
    constructor(e, t, n) {
        this._setter = t, this._dirty = !0, this.__v_isRef = !0, this.effect = oe(e, {
            lazy: !0,
            scheduler: () => {
                this._dirty || (this._dirty = !0, me(at(this), "set", "value"))
            }
        }), this.__v_isReadonly = n
    }
    get value() {
        return this._dirty && (this._value = this.effect(), this._dirty = !1), he(at(this), 0, "value"), this._value
    }
    set value(e) {
        this._setter(e)
    }
...
function gt(e, t, n, l = !0) {
    ...
    if (t) {
        ...
        if (o) return void mt(o, null, 10, [e, a, s])
    }! function (e, t, n, l = !0) {
        console.error(e)
    }(e, 0, 0, l)
}
...
function Ht(e) {
    ...
    try {
        ...
        if (4 & n.shapeFlag) {
            const t = a || l;
            m = Vl(u.call(t, t, d, s, f, p, h)), e = i
        } else {
            const n = t;
            0, m = Vl(n.length > 1 ? n(s, {
                attrs: i,
                slots: r,
                emit: c
        ...
        n.dirs && (b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs), n.transition && (b.transition = n.transition), m = b
    } catch (b) {
        gt(b, e, 1), m = Pl(vl)
    }
    return zt = null, m
...
function Rn(e, t, {
    ...
    let i, c, u = !1;
    if (ot(e) ? (i = () => e.value, u = !!e._shallow) : tt(e) ? (i = () => e, l = !0) : i = P(e) ? () => e.map((e => ot(e) ? e.value : tt(e) ? Pn(e) : M(e) ? mt(e, r, 2, [r && r.proxy]) : void 0)) : M(e) ? t ? () => mt(e, r, 2, [r && r.proxy]) : () => {
            if (!r || !r.isUnmounted) return c && c(), mt(e, r, 3, [d])
        } : k, t && l) {
        const e = i;
        i = () => Pn(e())
    }
    ...
    let h;
    f.allowRecurse = !!t, h = "sync" === a ? f : "post" === a ? () => sl(f, r && r.suspense) : () => {
    ...
    return ca(m, r), t ? n ? f() : p = m() : "post" === a ? sl(m, r && r.suspense) : m(), () => {
        re(m), r && T(r.effects, m)
    }
}
    ...
    const {
        ...
        leave(t, l) {
            ...
            const o = t._leaveCb = n => {
                s || (s = !0, l(), k(n ? h : f, [t]), t._leaveCb = void 0, y[a] === e && delete y[a])
            };
        ...
        setup(e, {
            ...
            return vn(g), yn(g), kn((() => {
                ...
                const f = null == r.key ? i : r.key,
                    h = n.get(f);
                return r.el && (r = Ll(r), 128 & o.shapeFlag && (o.ssContent = r)), b = f, h ? (r.el = h.el, r.component = h.component, r.transition && Nn(r, r.transition), r.shapeFlag |= 512, l.delete(f), l.add(f)) : (l.add(f), p && l.size > parseInt(p, 10) && m(l.values().next().value)), r.shapeFlag |= 256, a = r, o
            }
        }
    };
...
function rl(e) {
    return function (e, t) {
        const {
            ...
            [e.el, e.anchor] = m(e.children, t, n, l)
        }, C = ({
            el: e,
            anchor: t
        }, l, a) => {
            ...
            if (e.el && void 0 !== h && -1 === x) d = e.el = h(e.el);
                ...
                if (d = e.el = o(e.type, i, m && m.is), 8 & b ? u(d, e.children) : 16 & b && P(e.children, d, null, s, r, i && "foreignObject" !== f, c || !!e.dynamicChildren), y && Qn(e, null, s, "created"), m) {
                    for (const t in m) B(t) || a(d, t, null, m[t], i, e.children, s, r, ee);
                    (p = m.onVnodeBeforeMount) && il(p, s, e)
                }
                R(d, v, e, s)
            }
            y && Qn(e, null, s, "beforeMount");
            const k = (!r || r && !r.pendingBranch) && g && !g.persisted;
            k && g.beforeEnter(d), n(d, t, l), ((p = m && m.onVnodeMounted) || k || y) && sl((() => {
            ...
            const f = e.props || x,
                h = t.props || x;
            let m;
            if ((m = h.onVnodeBeforeUpdate) && il(m, n, t, e), p && Qn(t, e, n, "beforeUpdate"), c > 0) {
                if (16 & c) O(i, t, f, h, n, l, o);
                else if (2 & c && f.class !== h.class && a(i, "class", null, h.class, o), 4 & c && a(i, "style", f.style, h.style, o), 8 & c) {
            ...
            } else r || null != d || O(i, t, f, h, n, l, o);
            const b = o && "foreignObject" !== t.type;
            d ? I(e.dynamicChildren, d, i, n, l, b) : r || F(e, t, i, null, n, l, b), ((m = h.onVnodeUpdated) || p) && sl((() => {
                m && il(m, n, t, e), p && Qn(t, e, n, "updated")
            }), l)
        }, I = (e, t, n, l, a, s) => {
            ...
            if (i > u) {
                ...
                for (m = C.length - 1, i = v - 1; i >= 0; i--) {
                    const e = f + i,
                        r = t[e],
                        u = e + 1 < c ? t[e + 1].el : l;
                    0 === w[i] ? b(null, r, n, u, a, s, o) : x && (m < 0 || i !== C[m] ? q(r, n, u, 2) : m--)
                }
            }
        }, q = (e, t, l, a, s = null) => {
            const {
            ...
            const f = 1 & u && p;
            let h;
            if ((h = o && o.onVnodeBeforeUnmount) && il(h, t, e), 6 & u) Y(e.component, n, l);
            else {
            ...
            }((h = o && o.onVnodeUnmounted) || f) && sl((() => {
                h && il(h, t, e), f && Qn(e, null, t, "unmounted")
            }), n)
        }, J = e => {
            const {
                type: t,
...
function dl(e) {
    return hl("components", e) || e
}
const pl = Symbol();

function fl(e) {
    return V(e) ? hl("components", e, !1) || e : e || pl
}
...
function hl(e, t, n = !0) {
    ...
    if (l) {
        ...
        return ml(l[e] || n[e], t) || ml(l.appContext[e], t)
    }
}
...
const Tl = "__vInternal",
    ...
    Pl = function (e, t = null, n = null, l = 0, a = null, s = !1) {
        ...
        if (t) {
            ...
            e && !V(e) && (t.class = h(e)), U(n) && (lt(n) && !P(n) && (n = S({}, n)), t.style = u(n))
        }
...
function Nl(...e) {
    ...
    for (let n = 1; n < e.length; n++) {
        const l = e[n];
        for (const e in l)
            if ("class" === e) t.class !== l.class && (t.class = h([t.class, l.class]));
...
function zl(e, t, n = [], l = [], a = [], s = !1) {
    ...
    if (d && l.push(d), !s && l.length && l.forEach((e => {
        ...
        })), s && (h && S(e.components || (e.components = S({}, e.type.components)), h), m && S(e.directives || (e.directives = S({}, e.type.directives)), m)), s || Bl("created", "c", t, e, $), b && gn(b.bind(D)), g && vn(g.bind(D)), v && xn(v.bind(D)), y && yn(y.bind(D)), w && Bn(w.bind(D), "a", j), C && function (e, t) {
            Bn(e, "da", t)
        }(C.bind(D)), O && ((e, t = na) => {
            mn("ec", e, t)
...
const Xl = e => e ? sa(e) ? e.exposed ? e.exposed : e.proxy : Xl(e.parent) : null,
    ...
    Zl = {
        get({
            ...
            const u = Yl[t];
            let d, p;
            return u ? ("$attrs" === t && he(e, 0, t), u(e)) : (d = r.__cssModules) && (d = d[t]) ? d : n !== x && E(n, t) ? (o[t] = 3, n[t]) : (p = i.config.globalProperties, E(p, t) ? p[t] : void 0)
        },
        set({
            _: e
        }, t, n) {
...
function da(e) {
    const t = function (e) {
        let t, n;
        return M(e) ? (t = e, n = k) : (t = e.get, n = e.set), new ht(t, n, M(e) || !e.set)
    }(e);
...
const xa = {
    ...
    createElement: (e, t, n) => t ? ba.createElementNS(ma, e) : ba.createElement(e, n ? {
        is: n
    } : void 0),
    ...
    insertStaticContent(e, t, n, l) {
        const a = l ? va || (va = ba.createElementNS(ma, "svg")) : ga || (ga = ba.createElement("div"));
        a.innerHTML = e;
...
function Da(e) {
    ...
    const h = {};
    for (const S in e) S in Ma || (h[S] = e[S]);
    if (!l) return h;
    const m = function (e) {
...
function as(e, {
    ...
    e._modelValue = t, P(t) ? e.checked = b(t, l.props.value) > -1 : I(t) ? e.checked = t.has(l.props.value) : t !== n && (e.checked = m(t, ss(e, !0)))
}
...
let hs;
var ms, bs = "object" == typeof Reflect ? Reflect : null,
    gs = bs && "function" == typeof bs.apply ? bs.apply : function (e, t, n) {
        return Function.prototype.apply.call(e, t, n)
    };
ms = bs && "function" == typeof bs.ownKeys ? bs.ownKeys : Object.getOwnPropertySymbols ? function (e) {
...
const xo = vo("client"),
    yo = e => "https://fivem.jesteriruka.dev" + e,
    ko = new ys;
...
var Ao = {
    ...
    created() {
        ...
        })), this.settings.zoom = parseInt(localStorage.getItem("smartphone@zoom")) || 100, this.updateZoom(), this.localhost && (this.settings.case = "iphone14pro", this.settings.isAndroid = !1, document.documentElement.style.fontFamily = "Roboto", this.settings.backgroundURL = this.asset("stock/wallpapers/s20.webp"), this.settings.bankType = "bb", this.identity = {
            name: "Jester",
            firstname: "Iruka",
            user_id: 1,
            phone: "111-111"
...
an();
const _r = mr(((e, t, n, l, a, s) => (wl(), _l("div", br, [gr, Pl("div", vr, [l.recording ? (wl(), _l(bl, {
    key: 0
...
hr.render = _r, hr.__scopeId = "data-v-065406ae";
...
const bc = dc(((e, t, n, l, a, s) => (wl(), _l("div", {
    ...
    src: t.icon,
    alt: ""
}, null, 8, ["src"]), Pl("span", hc, g(t.name), 1)], 8, ["onClick"])))), 128))], 2), Pl("div", {
...
au.render = function (e, t, n, l, a, s) {
    ...
    }, [hu], 8, ["onClick"]), l.supportsVideoCall ? (wl(), _l("button", {
        key: 0,
...
cd.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l("div", ud, [Pl(o, {
        name: "Recentes"
    }), Pl("div", dd, [l.calls ? l.calls.length ? (wl(), _l("ul", hd, [(wl(!0), _l(bl, null, fa(l.calls, (t => (wl(), _l("li", {
        key: t.id,
        onClick: e => t.callback && l.createCall(t),
        class: "border-b border-theme p-5 flex items-center"
    }, [Pl("div", md, ["refused" === t.status && t.target == l.myPhone ? (wl(), _l("i", bd)) : "ok" === t.status ? (wl(), _l("i", {
        key: 1,
...
sp.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l("div", op, [Pl("div", rp, [l.path ? (wl(), _l("button", {
    ...
    }, [up]))]), Pl("div", dp, [l.path ? (wl(), _l("ul", mp, [(wl(!0), _l(bl, null, fa(l.files, (e => (wl(), _l("li", {
        key: e.id
    }, [Pl("div", {
        ...
        onClick: t => l.path = e
    }, [fp, Pl("h1", hp, g(l.folderLang[e]), 1)], 8, ["onClick"])))), 128))]))])])
};
const bp = {
        setup() {
            jl("setDark")();
...
const _p = {
        setup() {
            ...
            }), r.peer && (r.onicecandidate = e => e && b("addCandidate", e)), Ao.onceRoute("CALL_READY", h);
            ...
            return Ao.onceRoute("CALL_P2P", (({
                ...
                audios: p,
                accept: function () {
                    Ao.backend.answerPhoneCall(a.room), h()
                },
                block: function () {
...
Ao.pusher.on("WHATSAPP_GROUP", (e => {
    ...
    id: e
}) => gf(e))), Ao.pusher.on("WHATSAPP_READED", (e => delete hf[e])), Ao.pusher.on("WHATSAPP_AVATAR", (({
    phone: e,
    avatarURL: t
}) => mf[e] = t)), Ao.pusher.on("ADD_CONTACT", (async ({
    phone: e
}) => {
    ...
    if (e.channel_id > 1e9) bf(e.channel_id - 1e9, {
        ...
        e.other = vf(e);
        const t = ff.findIndex((t => vf(t) == e.other)); - 1 != t ? ff.splice(t, 1, e) : ff.push(e), e.sender != Ao.identity.phone && (hf[e.channel_id] = (hf[e.channel_id] || 0) + 1)
    }
        ...
        setup() {
            ...
            const m = da((() => {
                const e = l.value.trim().toLowerCase(),
                    t = [];
                return "chats" === n.value ? (t.push(...c.filter((t => e ? Bs(t.other).toLowerCase().includes(e) || t.other.includes(e) : 1)).map((e => h(e.other)))), e ? (t.push(...i.filter((t => t.name.toLowerCase().includes(e)))), Ao.contacts.value.forEach((n => {
                    t.some((e => e.phone == n.phone)) || (n.phone.includes(e) || n.name.toLowerCase().includes(e)) && t.push(h(n.phone))
                }))) : t.push(...i)) : "contacts" === n.value && Ao.contacts.value.forEach((n => {
                    (n.phone.includes(e) || n.name.toLowerCase().includes(e)) && t.push(h(n.phone))
                })), t.sort(((e, t) => {
                    var n, l;
...
yf.render = eh, yf.__scopeId = "data-v-0faff89a";
const th = {
        props: ["src"],
        setup(e) {
            const t = Ze({
...
th.render = function (e, t, n, l, a, s) {
    return wl(), _l("div", nh, [l.state.playing ? (wl(), _l("button", {
        key: 1,
    ...
    }, null, 4)]), Pl("span", oh, g(e.$filters.duration(l.state.duration)), 1)])
};
const rh = {
        components: {
            AudioPlayer: th,
        ...
        setup() {
            ...
            p.value || (d.startsWith("group") ? p.value = {
                ...
                p.value.id = e.id, e.name && (p.value.name = e.name), p.value.avatarURL = e.avatarURL || Ao.asset("/stock/user.svg"), o.value = e.messages.map(f), Lt((() => m(!0)))
            }));
            let h = 0;

            function m(e, t) {
                var n;
                !0 !== e && s.value || (null == (n = document.querySelector(".overflow-y-auto")) || n.scrollTo(0, 9e6), p.value.id < 1e9 && !t && h < Date.now() && (h = Date.now() + 1e3, Ao.backend.wpp_markAsRead(d), Ao.pusher.emit("WHATSAPP_READED", p.value.id)))
            }
            ...
            function g(e) {
                e.channel_id == p.value.id && (o.value.push(f(e)), Lt((() => m(!1, e.sender == t))))
            }
...
const ch = {
    ...
    Ah = Pl("b", null, "Clique para atualizar seu GPS", -1),
    Sh = {
        class: "break-words"
    },
    Th = {
    ...
    Vh = Pl("g", null, [Pl("g"), Pl("g", null, [Pl("path", {
...
an();
const Fh = ih(((e, t, n, l, a, s) => {
    var o, r, i;
    const c = dl("Header"),
        u = dl("AudioPlayer");
    return wl(), _l("div", ch, [l.android ? (wl(), _l(c, {
        key: 0
    }, {
        default: ih((() => {
            var n, a;
            return [Pl("div", uh, [Pl("button", {
                onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t)),
            ...
            }, [ph])) : Ml("", !0)]), l.chat.isGroup ? Ml("", !0) : (wl(), _l("div", fh, [l.hasVideoCall ? (wl(), _l("button", {
                key: 0,
    ...
    }, [vh])) : Ml("", !0)]), l.chat.isGroup ? Ml("", !0) : (wl(), _l("div", xh, [l.hasVideoCall ? (wl(), _l("button", {
        key: 0,
        onClick: t[10] || (t[10] = e => l.createCall(!0)),
        class: "mr-10"
    }, [yh])) : Ml("", !0), Pl("button", {
        onClick: t[11] || (t[11] = e => l.createCall())
    }, [kh])]))])), Pl("div", wh, [(wl(!0), _l(bl, null, fa(l.messages, (n => (wl(), _l("div", {
        class: "flex",
        key: n.id
    }, [Pl("div", {
    ...
    }, g(e.$filters.getNameByPhone(n.sender)), 5)) : Ml("", !0), n.image ? (wl(), _l("div", Ch, [Pl("img", {
        ...
        key: 3,
        src: n.content
    }, null, 8, ["src"])) : Ml("", !0), Pl("div", null, [Pl("span", Sh, g(e.$filters.isAudio(n.content) ? "" : n.content), 1), Pl("span", Th, [Il(g(e.$filters.unixToHHMM(n.created_at)) + " ", 1), n.sender == l.myPhone ? (wl(), _l("i", {
        key: 0,
        class: ["fal fa-check-double pl-2", {
            "text-blue-400": n.saw_at
        }]
    }, null, 2)) : Ml("", !0)])])], 2)])))), 128))]), l.recording ? (wl(), _l("div", Rh, [Pl("span", Eh, g(e.$filters.duration(l.recording.duration)), 1), Pl("button", {
        onClick: t[14] || (t[14] = e => l.recording.stop())
    }, [Ph])])) : Ml("", !0), l.android ? (wl(), _l("div", Lh, [Zn(Pl("input", {
        android: "",
        type: "text",
    ...
    }, [l.recording ? (wl(), _l("i", Dh)) : (wl(), _l("svg", Oh, [Mh, Vh]))])])) : (wl(), _l("div", Uh, [Pl("button", {
...
const zh = rt("https://fivem.jesteriruka.dev/stock/user.svg"),
    Bh = rt(""),
    ...
    qh = {
        ...
        setup() {
            ...
            const e = Ao.settings.isAndroid,
                ...
                l = ec(),
                a = rt(!0),
                s = da((() => Ao.contacts.value.filter((e => !Hh.includes(e.phone)))));
            return {
                android: e,
                dark: Ao.darkTheme,
                avatarURL: zh,
                ...
                submit: function () {
                    ...
                    if (zh.value.length > 255) return n("Imagem muito grande");
                    if (!(null == (e = Bh.value) ? void 0 : e.trim()) || Bh.value.length > 32) return n("Nome inválido");
                    if (Hh.length < 2) return n("Usuários insuficientes");
                    const t = Hh.filter(((e, t) => t));
                    Ao.backend.wpp_createGroup(Bh.value.trim(), zh.value, t).then((() => {
                        l.back()
                    })), zh.value = "https://fivem.jesteriruka.dev/stock/user.svg", Bh.value = "", Hh.length = 0, Hh.push(Ao.identity.phone)
                }
            }
        }
    },
    Gh = sn("data-v-007e0956");
ln("data-v-007e0956");
const Wh = {
        class: "h-16"
    },
...
const cm = Gh(((e, t, n, l, a, s) => {
    ...
    return wl(), _l("div", {
        ...
        default: Gh((() => [Pl("div", Wh, [Pl("button", {
            onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t)),
            class: "absolute left-0 px-4"
        }, [Kh]), Jh])])),
        _: 1
    })) : (wl(), _l("div", Xh, [Yh])), Pl("div", Zh, [Pl("div", Qh, [Pl("img", {
        src: l.avatarURL,
    ...
    }, [em], 2)]), Pl("div", null, [tm, Pl(r, {
        modelValue: l.name,
        "onUpdate:modelValue": t[3] || (t[3] = e => l.name = e),
        maxlength: "24",
        class: "text-3xl bg-transparent text-theme border"
    }, null, 8, ["modelValue"])]), Pl("label", nm, "Membros (" + g(l.invited.length) + "/100)", 1), Pl("ul", lm, [(wl(!0), _l(bl, null, fa(l.invited, ((t, n) => (wl(), _l("li", {
        key: n,
        class: "flex justify-between items-center mb-2 last:mb-0"
    }, [Pl("span", null, g(e.$filters.getNameByPhone(t)), 1), n ? (wl(), _l("div", am, [Pl("button", {
        onClick: e => l.removeMember(t),
        class: "pl-3"
    }, [sm], 8, ["onClick"])])) : Ml("", !0)])))), 128)), (wl(!0), _l(bl, null, fa(l.contacts, ((t, n) => (wl(), _l("li", {
        key: n,
        class: "flex justify-between items-center mb-2 last:mb-0"
    }, [Pl("span", null, g(e.$filters.getNameByPhone(t.phone)), 1), l.invited.length < 100 ? (wl(), _l("div", om, [Pl("button", {
        onClick: e => l.invited.push(t.phone),
        class: "pl-3"
    }, [rm], 8, ["onClick"])])) : Ml("", !0)])))), 128))]), l.invited.length > 1 ? (wl(), _l("div", im, [Pl("button", {
        onClick: t[4] || (t[4] = (...e) => l.submit && l.submit(...e)),
        class: "bg-blue-500 px-6 p-3 rounded-xl text-white"
    }, "Criar")])) : Ml("", !0)])], 2)
}));
qh.render = cm, qh.__scopeId = "data-v-007e0956";
const um = {
        components: {
            Header: qp
        },
...
an();
const Lm = dm(((e, t, n, l, a, s) => {
    const o = dl("Header"),
        r = dl("app-input");
    return wl(), _l("div", pm, [l.android ? (wl(), _l(o, {
        key: 0
    }, {
        default: dm((() => {
            var n;
            return [Pl("div", fm, [Pl("button", {
                onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t)),
                class: "absolute left-0 px-4"
            }, [hm]), Pl("h1", mm, g(null == (n = l.group.name) ? void 0 : n.slice(0, 20)), 1)])]
        })),
        _: 1
    })) : (wl(), _l("div", bm, [gm])), Pl("div", vm, [l.group.id ? (wl(), _l("div", xm, [Pl("img", {
        ...
        onClick: t[2] || (t[2] = e => l.promptAvatarURL()),
        class: ["absolute bottom-0 right-0 w-12 h-12 rounded-full bg-gray-500 border-2 flex flex-center", [l.dark ? "border-black" : "border-white"]]
    }, [ym], 2)) : Ml("", !0)])) : Ml("", !0), Pl("div", km, [wm, Pl(r, {
        value: l.group.name,
        onChange: t[3] || (t[3] = e => l.updateName(e.target.value)),
        maxlength: "24",
        class: "text-3xl bg-transparent text-theme border"
    }, null, 8, ["value"])]), l.group.members ? (wl(), _l("div", Cm, [Pl("label", null, "Membros (" + g(l.group.members.length + 1) + "/100)", 1), Pl("ul", _m, [(wl(!0), _l(bl, null, fa(l.members, (t => (wl(), _l("li", {
        key: t,
        class: "flex justify-between items-center mb-2 last:mb-0"
    }, [Pl("span", null, g(e.$filters.getNameByPhone(t)), 1), l.group.isOwner && t != l.group.owner ? (wl(), _l("div", Am, [l.group.members.includes(t) ? (wl(), _l("button", {
        key: 0,
        onClick: e => l.promoteMember(t),
        class: "px-3"
    }, [Sm], 8, ["onClick"])) : Ml("", !0), l.group.members.includes(t) ? (wl(), _l("button", {
        key: 1,
        onClick: e => l.removeMember(t),
        class: "pl-3"
    }, [Tm], 8, ["onClick"])) : l.group.members.length < 99 ? (wl(), _l("button", {
        key: 2,
        onClick: e => l.inviteMember(t),
        class: "pl-3"
    }, [Rm], 8, ["onClick"])) : Ml("", !0)])) : Ml("", !0)])))), 128))])])) : Ml("", !0), l.members.length > 1 && !l.group.isOwner ? (wl(), _l("div", Em, [Pl("button", {
        onClick: t[4] || (t[4] = (...e) => l.leaveGroup && l.leaveGroup(...e)),
        class: "text-red-500"
    }, "Sair do grupo")])) : Ml("", !0), l.group.isOwner ? (wl(), _l("div", Pm, [Pl("button", {
        onClick: t[5] || (t[5] = (...e) => l.destroyGroup && l.destroyGroup(...e)),
        class: "text-red-500"
    }, "Excluir o grupo")])) : Ml("", !0)])])
}));
um.render = Lm, um.__scopeId = "data-v-08fcb553";
const Im = {
...
Im.render = function (e, t, n, l, a, s) {
    return wl(), _l("div", Om, [Pl("div", Mm, [Pl("button", {
        onClick: t[1] || (t[1] = t => e.$router.back()),
        class: "absolute top-16 px-5"
    }, [l.isAndroid ? (wl(), _l("i", Vm)) : (wl(), _l("i", Dm))]), Pl("h1", Um, [Zt(e.$slots, "header"), n.hasBell ? (wl(), _l("button", {
        key: 0,
        onClick: t[2] || (t[2] = e => l.notifications = !l.notifications),
        class: "absolute top-20 right-8 w-6 h-4 flex flex-center"
    }, [l.notifications ? (wl(), _l("i", Nm)) : (wl(), _l("i", $m))])) : Ml("", !0)])]), Pl("div", jm, [Zt(e.$slots, "default")]), Zt(e.$slots, "footer"), !1 !== n.footer ? (wl(), _l("div", Fm, [(wl(!0), _l(bl, null, fa(l.routes, (t => (wl(), _l("button", {
        key: t.path,
        class: ["text-center", {
        ...
        class: t.icon
    }, null, 2), Pl("h1", zm, g(t.name), 1)], 10, ["onClick"])))), 128))])) : Ml("", !0)])
};
const Bm = Ze({
    id: "0",
    is(e) {
...
An((() => Ao.backend.tor_subscribe(Bm.groups))), Ao.pusher.on("TOR_MESSAGE", (e => {
    const t = String(e.sender);
    t != Bm.id && e.channel.startsWith("dm:") && !Bm.direct.includes(t) && Bm.direct.unshift(t)
}));
const Hm = {
        components: {
            Page: Im
        ...
        setup() {
            ...
            return Ao.backend.tor_blocked().then((t => {
            ...
            })), Ao.backend.tor_resume(Bm.direct).then((e => {
                t.value = Object.entries(e).map((([e, t]) => ({
                    id: e,
                    name: Bm.getNickname(e),
                ...
                if (e.channel.startsWith("dm:") && e.sender != Bm.id) {
                    const n = t.value.find((t => t.id == e.sender));
                    n && (n.message = e)
                }
            })), Ao.backend.tor_id().then((e => Bm.id = e)), {
                users: t,
                search: function () {
...
Hm.render = function (e, t, n, l, a, s) {
    const o = dl("Page");
    return wl(), _l(o, {
        hasBell: "yes"
    }, {
        ...
        default: en((() => [Pl("ul", null, [(wl(!0), _l(bl, null, fa(l.users, (t => (wl(), _l("li", {
            ...
            src: t.avatarURL
        }, null, 8, ["src"]), Pl("div", Gm, [Pl("div", Wm, [Pl("h1", Km, g(t.name), 1), t.message ? (wl(), _l("h1", Jm, g(e.$filters.unixToRelative(t.message.created_at)), 1)) : Ml("", !0)]), t.message ? (wl(), _l("p", Xm, [t.message.location ? (wl(), _l("span", Ym, "🌎 Localização")) : t.message.image ? (wl(), _l("span", Zm, "📷 Foto")) : (wl(), _l("span", Qm, g(t.message.content), 1))])) : (wl(), _l("p", eb, "Nenhuma mensagem..."))])], 8, ["onClick"])))), 128))]), Pl("button", {
...
const nb = {
        ...
        setup() {
            const e = ec(),
                t = rt([]);
            return Ao.backend.tor_resume(Bm.groups, !0).then((e => {
                t.value = Object.entries(e).map((([e, t]) => ({
                    id: e,
                    message: t
                }))).sort(((e, t) => e.message && t.message ? e.message.created_at > t.message.created_at ? -1 : 1 : e.message == t.message ? 0 : e.message ? -1 : 1))
...
const mb = {
        ...
        setup() {
            const e = tc(),
                t = da((() => e.params.id)),
                n = !t.value.match(/^\d+$/),
                l = rt(n ? "#" + t.value : Bm.getNickname(t.value));
            const a = da((() => n ? Bm.groups.includes(t.value) : Bm.direct.includes(t.value)));
            const s = e.params.id,
                o = rt(""),
                r = rt([]),
                i = da((() => {
            ...
            return Ao.backend.tor_messages(n ? s : parseInt(s)).then((e => {
                ...
                r.value.find((t => t.id == e.id)) || n && e.channel != t.value || (n || e.sender == t.value || e.sender == Bm.id) && (r.value.push(e), Lt(c))
            })), {
                state: Bm,
                input: o,
                messages: r,
                ...
                changeNickname: function () {
                    Ao.prompt("Insira o apelido", 12).then((e => {
                        ...
                        n && n.length <= 12 && (Bm.setNickname(t.value, n), l.value = n)
                    }))
                }
            }
        }
...
mb.render = Lb, mb.__scopeId = "data-v-c6a631a6";
const Ib = {
        components: {
            Page: Im
        },
...
ug.render = function (e, t, n, l, a, s) {
    ...
    }, [fg, "/instagram" === e.$route.path ? (wl(), _l("div", hg)) : Ml("", !0)]), Pl("button", {
        onClick: t[2] || (t[2] = t => e.$router.replace("/instagram/search"))
    }, [mg, "/instagram/search" === e.$route.path ? (wl(), _l("div", bg)) : Ml("", !0)]), Pl("button", {
...
rv.render = function (e, t, n, l, a, s) {
    ...
    }, [fv], 2)]), hv])), (wl(!0), _l(bl, null, fa(l.stories, ((n, a) => (wl(), _l("li", {
    ...
    }, [mv], 2)) : Ml("", !0)], 10, ["onClick"]), Pl("h1", bv, g(l.profile.username == a ? "Seu story" : a), 1)])))), 128))]), Pl("ul", null, [(wl(!0), _l(bl, null, fa(l.posts, (e => (wl(), _l("li", {
        postid: e.id,
        key: e.id
    }, [Pl(r, {
        post: e
...
hx.render = function (e, t, n, l, a, s) {
    var o;
    const r = dl("Header"),
        i = dl("app-verified"),
        c = dl("Bottom");
    return wl(), _l("div", mx, [Pl(r), !1 === l.profile ? (wl(), _l("h1", bx, "Perfil não encontrado")) : l.profile ? (wl(), _l("div", gx, [Pl("div", vx, [Pl("div", xx, [Pl("div", {
        class: ["w-28 h-28", {
...
an();
const by = py(((e, t, n, l, a, s) => (wl(), _l("div", fy, [Pl("div", hy, [Pl("i", {
    onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t)),
...
tw.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l(o, null, {
        ...
        }, null, 2)])])]), Pl("div", null, [Pl("div", ow, [rw, iw, l.visible ? (wl(), _l("h3", cw, g(e.$filters.intToMoney(l.balance)), 1)) : (wl(), _l("div", uw))]), Pl("div", dw, [pw, fw, l.visible ? (wl(), _l("h3", hw, g(e.$filters.intToMoney(l.invoices)), 1)) : (wl(), _l("div", mw))]), Pl("div", bw, [gw, vw, l.visible ? (wl(), _l("h3", xw, g(e.$filters.intToMoney(l.fines)), 1)) : (wl(), _l("div", yw))])])])])),
        _: 1
    })
};
const kw = {
...
const wC = pC(((e, t, n, l, a, s) => {
    ...
    return wl(), _l(o, {
        ...
        default: pC((() => [Pl("div", fC, [Pl("button", {
            class: "p-5 mt-8",
            onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t))
        }, [hC]), Pl("div", null, [Pl("div", mC, [bC, gC, Pl("div", vC, [Pl("p", xC, g(e.$currency) + " " + g(l.value), 1), Pl("p", null, "para " + g(l.name), 1), Pl("p", yC, [kC, Il(" • " + g(l.time), 1)])])])])])])),
        _: 1
    })
}));
...
YC.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l(o, {
        ...
        default: en((() => [Pl("div", ZC, [Pl("button", {
            ...
            class: "absolute inset-x-8 bottom-8"
        }, [c_])) : Ml("", !0)])) : 2 == l.step ? (wl(), _l("div", u_, [d_, p_, Pl("div", f_, [Pl("p", h_, g(e.$currency) + " " + g(l.receipt.value.toLocaleString("pt-BR")), 1), Pl("p", null, "para " + g(l.receipt.name), 1), Pl("p", m_, [b_, Il(" • " + g(l.receipt.time), 1)])])])) : Ml("", !0)])])),
        _: 1
    })
};
const g_ = {
...
qS.render = function (e, t, n, l, a, s) {
    ...
    }, [XS])) : Ml("", !0)]), Pl("div", YS, [Pl("div", ZS, [Pl("h1", QS, g(e.$filters.intToMoney(l.ad.price)), 1), Pl("h3", eT, g(l.ad.title), 1), Pl("span", tT, "Publicado em " + g(e.$filters.unixToDate(l.ad.created_at)), 1)]), nT, Pl("div", lT, [aT, Pl("span", sT, g(l.ad.description), 1)]), oT, Pl("div", rT, [iT, Pl("ul", cT, [Pl("li", null, [uT, Pl("span", dT, g(l.ad.author.name), 1)]), Pl("li", null, [pT, Pl("span", fT, g(l.ad.author.user_id), 1)]), Pl("li", null, [hT, Pl("span", mT, g(l.ad.author.phone), 1), l.yourself.phone != l.ad.author.phone ? (wl(), _l("button", {
        key: 0,
...
const xR = KT(((e, t, n, l, a, s) => {
    ...
    return wl(), _l("div", JT, [l.payload.image ? (wl(), _l("div", ZT, [Pl("img", {
    ...
    })])) : (wl(), _l("div", fR, [hR, Zn(Pl("textarea", {
        ...
        [ns, l.tmp.bio]
    ]), mR])) : (wl(), _l("div", dR, [pR, (wl(), _l(bl, null, fa({
        Male: "Homens",
        Female: "Mulheres",
        All: "Todos"
    }, ((e, t) => Pl("button", {
...
const gE = lE(((e, t, n, l, a, s) => {
    ...
    }, null, 8, ["modelValue"])]), Pl("div", fE, [Pl("div", hE, [mE, Pl(i, {
        modelValue: l.notifications,
...
hL.render = function (e, t, n, l, a, s) {
    return wl(), _l(bl, null, [Pl("div", mL, [Pl("div", bL, [Pl("div", gL, [vL, Pl("div", xL, [(wl(!0), _l(bl, null, fa(l.lastColors, ((t, n) => (wl(), _l("div", {
        key: n,
...
const ZL = {
        setup() {
            const e = Ao.settings.currency,
                ...
                p = jl("addBalance");
            let f, h = !1;
            async function m(e, t = 15e3) {
                clearInterval(h), h = setInterval((() => {
                    if (e <= 0) return c.value.innerHTML = "", u.value.style.width = "0%", clearInterval(h);
            ...
            return Ao.backend.casino_crash().then((async e => {
                i.push(...e.last), o.value = e.totalBet, "waiting" === e.status && e.delay ? await m(e.delay) : "crashing" === e.status ? (await b(e.multiplier), e.totalBet || (l.value = !0)) : "ending" === e.status && (r.value = !0, t.value = e.multiplier, l.value = !0)
            })), d("CASINO_CRASH_CASHOUT", (e => n.value = e)), d("CASINO_CRASH_ENDING", (e => {
                clearInterval(f), i.push(e) > 10 && i.shift(), t.value = e, r.value = !0, l.value = !0, m(5e3, 5e3)
            })), d("CASINO_CRASH_REFRESH", (() => {
                l.value = !1, t.value = 0, r.value = !1, o.value = 0, n.value = null
            })), d("CASINO_CRASH", (e => {
                t.value = 1, e ? r.value = !0 : b()
            })), d("CASINO_CRASH_WARMUP", (() => m(15e3))), wn((() => {
                clearInterval(f), clearInterval(h)
            })), {
                currency: e,
                timer: c,
                progress: u,
                ...
                bet: function () {
                    ...
                    if (n && n > 0) {
                        ...
                        Ao.backend.casino_crash_bet(n, l).then((e => {
                            e.error ? Ao.alert(e.error) : (o.value += n, p(-n), m(e.delay))
                        }))
                    }
                },
                stop: function () {
...
const xI = QL(((e, t, n, l, a, s) => (wl(), _l("div", eI, [Pl("div", tI, [Pl("ul", nI, [(wl(!0), _l(bl, null, fa(l.rounds, ((e, t) => (wl(), _l("li", {
...
}, g(l.waiting ? "Esperando" : "Começar o jogo"), 3)), Pl("div", fI, [Pl("div", hI, [Zn(Pl("input", {
    ...
    [ns, l.amount]
]), Pl("h1", mI, g(l.currency), 1)]), Pl("button", {
    ...
    wO = function (e) {
        ...
        function f(e, s) {
            ...
            const f = function (e, t) {
                ...
                hash: (h = c, Ui(h).replace(Oi, "{").replace(Vi, "}").replace(Li, "^")),
                path: r.path
            }));
            var h;
            let m = a.createHref(f);
            return Or({
                fullPath: f,
                hash: c,
        ...
        function g(e) {
            ...
            if (t && t.redirect) {
                ...
                return "string" == typeof l && (l = l.indexOf("?") > -1 || l.indexOf("#") > -1 ? l = h(l) : {
                    path: l
                }), Or({
                    query: e.query,
                    hash: e.hash,
...
SO.set("GPS", (({
    ...
    if ("geral" != e.channel && e.sender != Bm.id && AO() !== "/tor/" + (t ? e.sender : e.channel)) {
        const n = e.location ? "🌎 Localização" : e.image ? "📷 Foto" : e.content;
        Ao.addNotification("tor", t ? Bm.getNickname(e.sender) : "#" + e.channel, n)
    }
...
const LO = {
        ...
        setup() {
            ...
            })), globalThis.pusher = Ao.pusher, Ao.localhost && (globalThis.store = Ao), $l("useImageFocus", (e => m.value = e)), $l("setKeepInput", (e => x.value = e)), Ao.captureMicrophone(), window.addEventListener("message", (({
                data: {
                    event: e,
                    args: t
                }
...
LO.render = XO, LO.__scopeId = "data-v-ee1b0180";
const YO = {
        props: {
            modelValue: {
                required: !0
...
const rM = ((...e) => {
    const t = (hs || (hs = rl(fs))).createApp(...e),
        {
            mount: n
        } = t;
    return t.mount = e => {
...
rM.component("AppInput", NP), rM.component("AppSelect", $P), rM.component("AppToggle", YO), rM.component("AppLoading", tM), rM.component("AppVerified", lM), rM.use(_O), rM.config.globalProperties.$filters = Gs, rM.config.globalProperties.$asset = (e, t) => Ao.settings[t] || "https://fivem.jesteriruka.dev/" + e, Object.defineProperty(rM.config.globalProperties, "$currency", {
